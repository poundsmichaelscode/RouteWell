...
export const openapi = {
  ...
  components: {
    ...
    schemas: {
      ...
      DeliveryStatusInput: { type: "object", required: ["status"], properties: { status: { type: "string", enum: ["PENDING", "ASSIGNED", "PICKED_UP", "IN_TRANSIT", "DELIVERED", "FAILED", "CANCELLED"] }, note: { type: "string", maxLength: 500 }, latitude: { type: "number", minimum: -90, maximum: 90 }, longitude: { type: "number", minimum: -180, maximum: 180 } } },
